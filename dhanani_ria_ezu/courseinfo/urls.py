...
from courseinfo.views import (
    ...
    SectionDetail, CourseDetail, SemesterDetail, StudentDetail, RegistrationDetail, InstructorCreate, SectionCreate,
    CourseCreate, StudentCreate, RegistrationCreate, SemesterCreate, InstructorUpdate, SectionUpdate, CourseUpdate,
    SemesterUpdate, StudentUpdate, RegistrationUpdate, RegistrationDelete, InstructorDelete, SectionDelete, CourseDelete,
...
urlpatterns = [
    ...
    path('instructor/<int:pk>/',
         ...
         name='courseinfo_instructor_detail_list_urlpattern'),
    ...
    path('section/<int:pk>/',
         ...
         name='courseinfo_section_detail_list_urlpattern'),
    ...
    path('course/<int:pk>/',
         ...
         name='courseinfo_course_detail_list_urlpattern'),
    ...
    path('semester/<int:pk>/',
             ...
             name='courseinfo_semester_detail_list_urlpattern'),
    ...
    path('student/<int:pk>/',
             ...
             name='courseinfo_student_detail_list_urlpattern'),
    ...
    path('registration/<int:pk>/',
             ...
             name='courseinfo_registration_detail_list_urlpattern'),
