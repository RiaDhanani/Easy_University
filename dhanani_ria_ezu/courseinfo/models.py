...
class Semester(models.Model):
    ...
    def get_absolute_url(self):
        return reverse('courseinfo_semester_detail_list_urlpattern',
                       kwargs={'pk': self.pk}
                       )
...
class Instructor(models.Model):
    ...
    def get_absolute_url(self):
        return reverse('courseinfo_instructor_detail_list_urlpattern',
                       kwargs={'pk': self.pk}
                       )
...
class Student(models.Model):
    ...
    def get_absolute_url(self):
        return reverse('courseinfo_student_detail_list_urlpattern',
                       kwargs={'pk': self.pk}
                       )
...
class Section(models.Model):
    ...
    def get_absolute_url(self):
        return reverse('courseinfo_section_detail_list_urlpattern',
                       kwargs={'pk': self.pk}
                       )
...
class Registration(models.Model):
    ...
    def get_absolute_url(self):
        return reverse('courseinfo_registration_detail_list_urlpattern',
                       kwargs={'pk': self.pk}
                       )
